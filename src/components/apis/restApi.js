...
const getUserinfoByEmail = async (email, component) => {
    const url = 'http://34.64.253.11:8080/api/user/info/' + email;
    console.log(url);
    const data = await axios.get(
        'http://34.64.253.11:8080/api/user/info/' + email
        // "http://34.64.253.11:8080/api/user/info/2c6829%40naver.com"
    );
...
const getNewsCompanies = async () => {
    ...
    const url = 'http://34.64.253.11:8080/api/company-list';
...
const getNewsData = async (id, component) => {
    ...
    const url = 'http://34.64.253.11:8080/api/user/contents/' + id + '/' + todayDateString;
...
const deleteKeyword = async (id, keyword) => {
    const url = 'http://34.64.253.11:8080/api/user/keyword/delete?id=' + id + '&keyWord=' + keyword;
...
const addKeyword = async (id, keyword) => {
    const url = 'http://34.64.253.11:8080/api/user/keyword/add?id=' + id + '&keyWord=' + keyword;
    console.log(url);
    const result = await axios.put(url);
...
const testPost = async () => {
    const result = await axios.put("http://34.64.253.11:8080/api/user/keyword/add?id=12467&keyWord=안녕하세요");

    return result;
}
const addNewdCompany = async (companyid, userid) => {
    const url = 'http://34.64.253.11:8080/api/user/news-comany/add?companyid=' + companyid + '&userid=' + userid;
    const result = await axios.put(url);

    return result;
}
const subNewdCompany = async (companyid, userid) => {
    const url = 'http://34.64.253.11:8080/api/user/news-comany/sub?companyid=' + companyid + '&userid=' + userid;
    const result = await axios.put(url);
